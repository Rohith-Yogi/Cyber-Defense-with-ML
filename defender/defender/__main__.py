...
from defender.defender.apps import create_app

# CUSTOMIZE: import model to be used

from defender.defender.pipeline.pipeline_models import Model
from defender.defender.nfs.nfs import NeedForSpeedModel
